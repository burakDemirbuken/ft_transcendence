...
class GameRenderer extends EventEmitter {
    ...
    */
    ...
    async tournamentInitialize(arcadeCount = 0, playerOwnerNumber = 0) {
    ...
    async classicInitialize() {
        ...
        this.gameCore.setCameraPosition({ x: this.playerMachine.position.x, y: this.playerMachine.position.y + cameraHeight, z: this.playerMachine.position.z - cameraDistance }, { x: this.playerMachine.position.x, y: this.playerMachine.position.y + 3.75, z: this.playerMachine.position.z });
    }
    startRendering() {
        this.isRunning = true;
        this.gameLoop();
