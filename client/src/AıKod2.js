...
// Client'tan server'a gönderilen hareket verileri:
// { type: 'move', payload: { player: 1, direction: 'up' } }
// { type: 'move', payload: { player: 1, direction: 'down' } }
// { type: 'move', payload: { player: 1, direction: 'stop' } }
*/