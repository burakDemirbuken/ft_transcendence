...
class ManagerProfile {
    constructor() {
        this.showcharts = {}; // Chart.js nesnelerini saklamak için
        this.chartData = {
    ...
    setupEventListeners() {
        ...
        timeFilter === null || timeFilter === void 0 ? void 0 : timeFilter.addEventListener('change', (e) => {
            const target = e.target;
            this.filterMatches('time', target.value);
        });
        const resultFilter = document.getElementById('result-filter');
        resultFilter === null || resultFilter === void 0 ? void 0 : resultFilter.addEventListener('change', (e) => {
            const target = e.target;
    ...
    fetchFriends() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const response = yield fetch("/api/friends");
                if (!response.ok)
...
document.addEventListener("DOMContentLoaded", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const friends = yield profileManager.fetchFriends(); // ManagerProfile içine koyabiliriz
...
function filterTournaments() {
    var _a, _b, _c, _d;
    const yearFilter = (_b = (_a = document.getElementById('tournament-year-filter')) === null || _a === void 0 ? void 0 : _a.value) !== null && _b !== void 0 ? _b : 'all';
    const typeFilter = (_d = (_c = document.getElementById('tournament-type-filter')) === null || _c === void 0 ? void 0 : _c.value) !== null && _d !== void 0 ? _d : 'all';
...
(_a = document.getElementById('tournament-year-filter')) === null || _a === void 0 ? void 0 : _a.addEventListener('change', filterTournaments);
(_b = document.getElementById('tournament-type-filter')) === null || _b === void 0 ? void 0 : _b.addEventListener('change', filterTournaments);
